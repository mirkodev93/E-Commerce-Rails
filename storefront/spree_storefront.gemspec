...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'tailwindcss-ruby', '>= 3.4.17', '< 4.3.0' # lock at Tailwind v3 for now, https://github.com/rails/tailwindcss-rails?tab=readme-ov-file#choosing-a-specific-version-of-tailwindcss
